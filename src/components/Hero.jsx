        ...
        <div className='hero-sec'>
            ...
            <div className="text-div">
                <form onSubmit={generateAnswer} >
                    ...
                    <button disabled onClick={generateAnswer} type='button'><i className="fa-regular fa-paper-plane"></i></button>
                </form>
            </div>

            <div class="alert alert-danger m-3 " role="alert">
            <i class="fa-solid fa-triangle-exclamation"></i>  Oh no! This feature is currently unavailable. We apologize for the inconvenience.
            </div>
